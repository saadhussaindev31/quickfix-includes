...
public:
  ...
  sys_socket_t connect( const std::string& address, int port, bool noDelay,
...
public:
  ...
  public:
    virtual ~Strategy() {}
    virtual void onConnect( SocketConnector&, sys_socket_t socket ) = 0;
    virtual void onWrite( SocketConnector&, sys_socket_t socket ) = 0;
    virtual bool onData( SocketConnector&, sys_socket_t socket ) = 0;
    virtual void onDisconnect( SocketConnector&, sys_socket_t socket ) = 0;
