...
namespace FIX50SP2
{
  ...
  {
    static FIX::MsgType::Pack PackedType() { return FIX::MsgType::Pack("CC"); }
  public:
    StreamAssignmentRequest() : Message(PackedType()) {}
    ...
    : Message(PackedType())
    {
      ...
      Sequence::push_back_to(*this, aStreamAsgnReqID);
      Sequence::push_back_to(*this, aStreamAsgnReqType);
    }

    StreamAssignmentRequest(
      const FIX::StreamAsgnReqID::Pack& aStreamAsgnReqID,
      const FIX::StreamAsgnReqType::Pack& aStreamAsgnReqType )
    : Message(PackedType())
    {
      // must be in this order
      Sequence::push_back_to(*this, aStreamAsgnReqID);
