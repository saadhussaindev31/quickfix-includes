...
namespace FIX50SP1
{
  ...
  {
    static FIX::MsgType::Pack PackedType() { return FIX::MsgType::Pack("BV"); }
  public:
    MarketDefinitionUpdateReport() : Message(PackedType()) {}
    ...
    : Message(PackedType())
    {
      ...
      Sequence::push_back_to(*this, aMarketID);
      Sequence::push_back_to(*this, aMarketReportID);
    }

    MarketDefinitionUpdateReport(
      const FIX::MarketReportID::Pack& aMarketReportID,
      const FIX::MarketID::Pack& aMarketID )
    : Message(PackedType())
    {
      // must be in this order
      Sequence::push_back_to(*this, aMarketID);
