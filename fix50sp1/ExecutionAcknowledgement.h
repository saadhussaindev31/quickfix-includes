...
namespace FIX50SP1
{
  ...
  {
    static FIX::MsgType::Pack PackedType() { return FIX::MsgType::Pack("BN"); }
  public:
    ExecutionAcknowledgement() : Message(PackedType()) {}
    ...
    : Message(PackedType())
    {
      ...
      Sequence::push_back_to(*this, aExecAckStatus);
    }

    ExecutionAcknowledgement(
      const FIX::OrderID::Pack& aOrderID,
      const FIX::ExecAckStatus::Pack& aExecAckStatus,
