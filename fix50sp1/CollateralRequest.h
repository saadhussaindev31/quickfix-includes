...
namespace FIX50SP1
{
  ...
  {
    static FIX::MsgType::Pack PackedType() { return FIX::MsgType::Pack("AX"); }
  public:
    CollateralRequest() : Message(PackedType()) {}
    ...
    : Message(PackedType())
    {
      ...
      Sequence::push_back_to(*this, aCollReqID);
      Sequence::push_back_to(*this, aCollAsgnReason);
    }

    CollateralRequest(
      const FIX::CollReqID::Pack& aCollReqID,
