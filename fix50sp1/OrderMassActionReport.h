...
namespace FIX50SP1
{
  ...
  {
    static FIX::MsgType::Pack PackedType() { return FIX::MsgType::Pack("BZ"); }
  public:
    OrderMassActionReport() : Message(PackedType()) {}
    ...
    : Message(PackedType())
    {
      ...
      Sequence::push_back_to(*this, aMassActionReportID);
      Sequence::push_back_to(*this, aMassActionType);
      Sequence::push_back_to(*this, aMassActionScope);
      Sequence::push_back_to(*this, aMassActionResponse);
    }

    OrderMassActionReport(
      const FIX::MassActionReportID::Pack& aMassActionReportID,
      const FIX::MassActionType::Pack& aMassActionType,
      const FIX::MassActionScope::Pack& aMassActionScope,
      const FIX::MassActionResponse::Pack& aMassActionResponse )
    : Message(PackedType())
    {
      // must be in this order
      Sequence::push_back_to(*this, aMassActionReportID);
