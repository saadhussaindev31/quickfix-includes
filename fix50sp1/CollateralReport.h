...
namespace FIX50SP1
{
  ...
  {
    static FIX::MsgType::Pack PackedType() { return FIX::MsgType::Pack("BA"); }
  public:
    CollateralReport() : Message(PackedType()) {}
    ...
    : Message(PackedType())
    {
      ...
      Sequence::push_back_to(*this, aCollRptID);
      Sequence::push_back_to(*this, aCollStatus);
    }

    CollateralReport(
      const FIX::CollRptID::Pack& aCollRptID,
      const FIX::CollStatus::Pack& aCollStatus )
    : Message(PackedType())
    {
      // must be in this order
      Sequence::push_back_to(*this, aCollRptID);
