...
namespace FIX50SP1
{
  ...
  {
    static FIX::MsgType::Pack PackedType() { return FIX::MsgType::Pack("BO"); }
  public:
    ContraryIntentionReport() : Message(PackedType()) {}
    ...
    : Message(PackedType())
    {
      ...
      Sequence::push_back_to(*this, aContIntRptID);
    }

    ContraryIntentionReport(
      const FIX::ContIntRptID::Pack& aContIntRptID,
