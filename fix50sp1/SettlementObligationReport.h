...
namespace FIX50SP1
{
  ...
  {
    static FIX::MsgType::Pack PackedType() { return FIX::MsgType::Pack("BQ"); }
  public:
    SettlementObligationReport() : Message(PackedType()) {}
    ...
    : Message(PackedType())
    {
      ...
      Sequence::push_back_to(*this, aSettlObligMode);
      Sequence::push_back_to(*this, aSettlObligMsgID);
    }

    SettlementObligationReport(
      const FIX::SettlObligMsgID::Pack& aSettlObligMsgID,
      const FIX::SettlObligMode::Pack& aSettlObligMode )
    : Message(PackedType())
    {
      // must be in this order
      Sequence::push_back_to(*this, aSettlObligMode);
