...
namespace FIX44
{
  ...
  {
    static FIX::MsgType::Pack PackedType() { return FIX::MsgType::Pack("AO"); }
  public:
    RequestForPositionsAck() : Message(PackedType()) {}
