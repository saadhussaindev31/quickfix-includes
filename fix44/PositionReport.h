...
namespace FIX44
{
  ...
  {
    static FIX::MsgType::Pack PackedType() { return FIX::MsgType::Pack("AP"); }
  public:
    PositionReport() : Message(PackedType()) {}
    ...
    : Message(PackedType())
    {
      ...
      Sequence::push_back_to(*this, aPosReqResult);
      Sequence::push_back_to(*this, aSettlPrice);
      Sequence::push_back_to(*this, aSettlPriceType);
      Sequence::push_back_to(*this, aPriorSettlPrice);
    }

    PositionReport(
      const FIX::PosMaintRptID::Pack& aPosMaintRptID,
      const FIX::PosReqResult::Pack& aPosReqResult,
      ...
      const FIX::PriorSettlPrice::Pack& aPriorSettlPrice )
    : Message(PackedType())
    {
      // must be in this order
      Sequence::push_back_to(*this, aAccount);
