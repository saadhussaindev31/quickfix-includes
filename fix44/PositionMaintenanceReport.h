...
namespace FIX44
{
  ...
  {
    static FIX::MsgType::Pack PackedType() { return FIX::MsgType::Pack("AM"); }
  public:
    PositionMaintenanceReport() : Message(PackedType()) {}
    ...
    : Message(PackedType())
    {
      ...
      Sequence::push_back_to(*this, aAccount);
      Sequence::push_back_to(*this, aTransactTime);
      Sequence::push_back_to(*this, aAccountType);
      Sequence::push_back_to(*this, aPosTransType);
      Sequence::push_back_to(*this, aPosMaintAction);
      Sequence::push_back_to(*this, aOrigPosReqRefID);
      Sequence::push_back_to(*this, aClearingBusinessDate);
      Sequence::push_back_to(*this, aPosMaintRptID);
      Sequence::push_back_to(*this, aPosMaintStatus);
    }

    PositionMaintenanceReport(
      const FIX::PosMaintRptID::Pack& aPosMaintRptID,
      const FIX::PosTransType::Pack& aPosTransType,
      const FIX::PosMaintAction::Pack& aPosMaintAction,
      const FIX::OrigPosReqRefID::Pack& aOrigPosReqRefID,
      const FIX::PosMaintStatus::Pack& aPosMaintStatus,
      const FIX::ClearingBusinessDate::Pack& aClearingBusinessDate,
      const FIX::Account::Pack& aAccount,
