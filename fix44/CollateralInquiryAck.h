...
namespace FIX44
{
  ...
  {
    static FIX::MsgType::Pack PackedType() { return FIX::MsgType::Pack("BG"); }
  public:
    CollateralInquiryAck() : Message(PackedType()) {}
    ...
    : Message(PackedType())
    {
      ...
      Sequence::push_back_to(*this, aCollInquiryID);
      Sequence::push_back_to(*this, aCollInquiryStatus);
    }

    CollateralInquiryAck(
      const FIX::CollInquiryID::Pack& aCollInquiryID,
      const FIX::CollInquiryStatus::Pack& aCollInquiryStatus )
    : Message(PackedType())
    {
      // must be in this order
      Sequence::push_back_to(*this, aCollInquiryID);
