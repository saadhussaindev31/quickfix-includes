...
namespace FIX44
{
  ...
  {
    static FIX::MsgType::Pack PackedType() { return FIX::MsgType::Pack("AY"); }
  public:
    CollateralAssignment() : Message(PackedType()) {}
    ...
    : Message(PackedType())
    {
      ...
      Sequence::push_back_to(*this, aCollAsgnTransType);
    }

    CollateralAssignment(
      const FIX::CollAsgnID::Pack& aCollAsgnID,
      const FIX::CollAsgnReason::Pack& aCollAsgnReason,
      const FIX::CollAsgnTransType::Pack& aCollAsgnTransType,
