...
namespace FIX44
{
  ...
  {
    static FIX::MsgType::Pack PackedType() { return FIX::MsgType::Pack("AQ"); }
  public:
    TradeCaptureReportRequestAck() : Message(PackedType()) {}
    ...
    : Message(PackedType())
    {
      ...
      Sequence::push_back_to(*this, aTradeRequestResult);
      Sequence::push_back_to(*this, aTradeRequestStatus);
    }

    TradeCaptureReportRequestAck(
      const FIX::TradeRequestID::Pack& aTradeRequestID,
      const FIX::TradeRequestType::Pack& aTradeRequestType,
      const FIX::TradeRequestResult::Pack& aTradeRequestResult,
      const FIX::TradeRequestStatus::Pack& aTradeRequestStatus )
    : Message(PackedType())
    {
      // must be in this order
      Sequence::push_back_to(*this, aTradeRequestID);
